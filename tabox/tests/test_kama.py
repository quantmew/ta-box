...
class TestKAMA(unittest.TestCase):
    def test_random_vector(self):
        for i in range(100, 300):
            ...
            self.assertTrue(np.array_equal(this_kama, that_kama, equal_nan=True), f"{close}, {this_kama}, {that_kama}")
    ...
    def test_custom_periods(self):
        ...
        self.assertTrue(np.array_equal(this_kama, that_kama, equal_nan=True))
