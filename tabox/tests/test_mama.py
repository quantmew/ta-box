...
class TestMAMA(unittest.TestCase):
    def test_random_vector(self):
        for i in range(100, 300):
            ...
            self.assertTrue(np.array_equal(this_mama, that_mama, equal_nan=True), f"{close}, {this_mama}, {that_mama}")
            self.assertTrue(np.array_equal(this_fama, that_fama, equal_nan=True), f"{close}, {this_fama}, {that_fama}")
    ...
    def test_custom_limits(self):
        ...
        self.assertTrue(np.array_equal(this_mama, that_mama, equal_nan=True))
        self.assertTrue(np.array_equal(this_fama, that_fama, equal_nan=True))
